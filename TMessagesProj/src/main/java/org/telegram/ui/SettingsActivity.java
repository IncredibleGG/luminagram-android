...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        // LuminaGram: fork settings hub pinned to the very top of Settings as its own first card (like exteraGram)
        items.add(SettingCell.Factory.of(100, IconBackgroundColors.PURPLE.top, IconBackgroundColors.PURPLE.bottom, R.drawable.settings_devices, LuminaLocale.getString(R.string.LuminaGramSettings), LuminaLocale.getString(R.string.LuminaGramSettingsInfo)));
        items.add(UItem.asShadow(null)); // LuminaGram: divider below the pinned hub card
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            case 100:
                presentSettingFragment(new LuminaGramSettingsActivity());
                break;
            case 1:
