...
public final class LuminaLocale {
    ...
    static {
        ...
        zhHans.put("LuminaTrSendEnableDialog", "翻译我在此对话发送的消息");
        zhHans.put("LuminaTrSendDisableDialog", "关闭此对话的发送前翻译");
        zhHans.put("LuminaTrSendDialogEnabled", "已开启此对话的发送前翻译");
        zhHans.put("LuminaTrSendDialogDisabled", "已关闭此对话的发送前翻译");
        ...
        zhHans.put("ProfileRiskHomoglyph", "⚠ 名称含视觉近似字，可能冒充他人");
        zhHans.put("LuminaTranslateTitle", "自动翻译");
        zhHans.put("LuminaTranslateHeader", "翻译");
        zhHans.put("LuminaTranslateTo", "翻译为");
        zhHans.put("LuminaDualLanguageDisplay", "自动翻译（双语显示）");
        zhHans.put("LuminaFoldOriginalLongMessages", "长消息自动折叠原文");
        zhHans.put("LuminaFoldOriginalLongMessagesInfo", "在双语长消息中，原文会折叠成一行，以免刷屏。点一下即可展开。译文始终完整显示。");
        zhHans.put("LuminaExpandOriginal", "展开原文");
        ...
        zhHans.put("LuminaTranslateSendLangAutoShort", "自动");
        ...
        zhHans.put("LuminaTranslateBeforeSendInfo", "这只是启用功能，本身不翻译任何对话。请到每个对话单独打开：长按发送按钮，或打开该对话的翻译菜单。");
        ...
        zhHans.put("LuminaGlossaryTitle", "不翻译词表");
        zhHans.put("LuminaGlossaryHeader", "词条");
        zhHans.put("LuminaGlossaryAdd", "添加词条");
        zhHans.put("LuminaGlossaryEdit", "编辑词条");
        zhHans.put("LuminaGlossaryTerm", "词条");
        zhHans.put("LuminaGlossaryInfo", "列表中的词永远不会被翻译，会原样保留。适合用于品牌名、产品型号、人名，以及翻译引擎容易弄坏的词。@用户名和链接始终保持原样，即使不在列表中。匹配以整词为准、不区分大小写。此列表为全局，适用于所有对话。");
        zhHans.put("LuminaGlossaryManage", "不翻译词表…");
        ...
        zhHans.put("LuminaMediaSaveFolderInfo", "保存到相册的照片、视频和文件会存入以此命名的相册，位于 Pictures、Movies、Download 和 Music 下。留空则使用 LuminaGram 文件夹。本次更新之前保存的媒体仍留在旧的 Telegram 文件夹里——此设置不会移动已有文件。");
        ...
        zhHans.put("LuminaVaultIconInfo", "保险箱开启时，桌面图标和名称会自动跟随假 App。若想自己决定图标，请到上方“应用伪装”中手动挑选。");
        ...
        zhHans.put("LuminaChatLockAdd", "加入私密文件夹");
        zhHans.put("LuminaChatLockRemove", "移出私密文件夹");
        zhHans.put("LuminaChatLockHiddenToast", "已隐藏。在搜索框输入密码即可显示。");
        zhHans.put("LuminaChatLockSetCodeTitle", "设置显示密码");
        zhHans.put("LuminaChatLockSetCodeMessage", "在聊天搜索框输入此密码即可显示私密文件夹。请妥善保管。");
        zhHans.put("LuminaChatLockSetCodeSave", "保存");
        zhHans.put("LuminaChatLockCodeHint", "显示密码");
        zhHans.put("LuminaRequestInboxTitle", "陌生人请求");
        zhHans.put("LuminaRequestInboxBannerSubtitle", "%1$d 条待处理");
        zhHans.put("LuminaRequestInboxEmpty", "没有待处理的请求。");
        zhHans.put("LuminaRequestInboxOpen", "打开对话");
        zhHans.put("LuminaRequestInboxAccept", "接受");
        zhHans.put("LuminaRequestInboxBlock", "封锁");
        zhHans.put("LuminaRequestInboxReport", "举报");
        zhHans.put("LuminaRequestInboxReportConfirm", "举报此账号为垃圾信息并封锁？");
        zhHans.put("LuminaRequestInboxAcceptedToast", "已接受，已移入你的聊天。");
        zhHans.put("LuminaRequestInboxReportedToast", "已举报并封锁。");
        ...
        zhHans.put("LuminaSttEngineVoskShort", "Vosk");
        zhHans.put("LuminaSttEngineWhisperShort", "Whisper");
        zhHans.put("LuminaSttEngineGoogleShort", "Google");
        ...
        zhHans.put("LuminaSttModelsTitle", "离线语音模型");
        zhHans.put("LuminaSttModelsNone", "未选择");
        zhHans.put("LuminaSttModelInstalled", "已安装 · %1$s");
        zhHans.put("LuminaSttModelDownloadSize", "下载 · %1$s");
        zhHans.put("LuminaSttModelsInfo", "Vosk 只为以下语言提供离线模型，其他语言无法在本机转录。点一下语言即可下载对应模型并用于转录；长按已下载的模型可以删除。");
        zhHans.put("LuminaSttModelsStorage", "本机语音模型占用：%1$s");
        zhHans.put("LuminaSttDeleteModel", "删除语音模型");
        zhHans.put("LuminaSttDeleteModelConfirm", "删除 %1$s 语音模型？可释放 %2$s，随时可以重新下载。");
        zhHans.put("LuminaSttModelDeleted", "已删除 %1$s 语音模型");
...
zhHans.put("LuminaDigestTitle", "未读摘要");
        ...
        zhHans.put("LuminaTranslateMoreHeader", "更多");
        zhHans.put("LuminaExplainSetting", "解释这条消息");
        zhHans.put("LuminaExplainSettingInfo", "在消息长按菜单里加入「解释一下」，用你自己的 LLM 拆解语气、俚语和该怎么回。");
        zhHans.put("LuminaGroupSkipSetting", "群组里跳过你看得懂的语言");
        zhHans.put("LuminaGroupSkipSettingInfo", "群组开启翻译时，已经是你看得懂的语言的消息就不翻译。");
        zhHans.put("LuminaReverseVoiceSetting", "把文字翻译后当语音发送");
        zhHans.put("LuminaReverseVoiceSettingInfo", "实验性。长按发送键把你的文字翻译后，以设备合成的语音消息发出。");
        zhHans.put("LuminaStrangerInboxHeader", "陌生人请求");
        zhHans.put("LuminaStrangerInbox", "陌生人请求匣");
        zhHans.put("LuminaStrangerInboxInfo", "把非联系人、且与你没有共同群组的人发来的消息，收进独立的请求列表，而不是主聊天列表。");
        ...
        zhHant.put("LuminaTrSendEnableDialog", "翻譯我在此對話傳送的訊息");
        zhHant.put("LuminaTrSendDisableDialog", "關閉此對話的傳送前翻譯");
        zhHant.put("LuminaTrSendDialogEnabled", "已開啟此對話的傳送前翻譯");
        zhHant.put("LuminaTrSendDialogDisabled", "已關閉此對話的傳送前翻譯");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        zhHant.put("ProfileRiskHomoglyph", "⚠ 名稱含視覺近似字，可能冒充他人");
        zhHant.put("LuminaTranslateTitle", "自動翻譯");
        zhHant.put("LuminaTranslateHeader", "翻譯");
        zhHant.put("LuminaTranslateTo", "翻譯成");
        zhHant.put("LuminaDualLanguageDisplay", "自動翻譯（雙語顯示）");
        zhHant.put("LuminaFoldOriginalLongMessages", "長訊息自動摺疊原文");
        zhHant.put("LuminaFoldOriginalLongMessagesInfo", "在雙語長訊息中，原文會摺疊成一行，以免洗版。點一下即可展開。譯文一律完整顯示。");
        zhHant.put("LuminaExpandOriginal", "展開原文");
        ...
        zhHant.put("LuminaTranslateSendLangAutoShort", "自動");
        ...
        zhHant.put("LuminaTranslateBeforeSendInfo", "這只是啟用功能，本身不翻譯任何對話。請到每個對話單獨開啟：長按傳送按鈕，或開啟該對話的翻譯選單。");
        ...
        zhHant.put("LuminaGlossaryTitle", "不翻譯詞表");
        zhHant.put("LuminaGlossaryHeader", "詞條");
        zhHant.put("LuminaGlossaryAdd", "新增詞條");
        zhHant.put("LuminaGlossaryEdit", "編輯詞條");
        zhHant.put("LuminaGlossaryTerm", "詞條");
        zhHant.put("LuminaGlossaryInfo", "清單中的詞永遠不會被翻譯，會原樣保留。適合用於品牌名稱、產品型號、人名，以及翻譯引擎容易弄壞的詞。@使用者名稱和連結一律保持原樣，即使不在清單中。比對以整詞為準、不區分大小寫。此清單為全域，適用於所有對話。");
        zhHant.put("LuminaGlossaryManage", "不翻譯詞表…");
        ...
        zhHant.put("LuminaMediaSaveFolderInfo", "儲存到相簿的相片、影片和檔案會存入以此命名的相簿，位於 Pictures、Movies、Download 和 Music 下。留空則使用 LuminaGram 資料夾。本次更新之前儲存的媒體仍留在舊的 Telegram 資料夾裡——此設定不會移動現有檔案。");
        ...
        zhHant.put("LuminaVaultIconInfo", "保險箱開啟時，桌面圖示與名稱會自動跟著假 App 走。若想自己決定圖示，請到上方「應用偽裝」中手動挑選。");
        ...
        zhHant.put("LuminaChatLockAdd", "加入私密資料夾");
        zhHant.put("LuminaChatLockRemove", "移出私密資料夾");
        zhHant.put("LuminaChatLockHiddenToast", "已隱藏。在搜尋框輸入密碼即可顯示。");
        zhHant.put("LuminaChatLockSetCodeTitle", "設定顯示密碼");
        zhHant.put("LuminaChatLockSetCodeMessage", "在聊天搜尋框輸入此密碼即可顯示私密資料夾。請妥善保管。");
        zhHant.put("LuminaChatLockSetCodeSave", "儲存");
        zhHant.put("LuminaChatLockCodeHint", "顯示密碼");
        zhHant.put("LuminaRequestInboxTitle", "陌生人請求");
        zhHant.put("LuminaRequestInboxBannerSubtitle", "%1$d 則待處理");
        zhHant.put("LuminaRequestInboxEmpty", "沒有待處理的請求。");
        zhHant.put("LuminaRequestInboxOpen", "開啟對話");
        zhHant.put("LuminaRequestInboxAccept", "接受");
        zhHant.put("LuminaRequestInboxBlock", "封鎖");
        zhHant.put("LuminaRequestInboxReport", "檢舉");
        zhHant.put("LuminaRequestInboxReportConfirm", "檢舉此帳號為垃圾訊息並封鎖？");
        zhHant.put("LuminaRequestInboxAcceptedToast", "已接受，已移入你的聊天。");
        zhHant.put("LuminaRequestInboxReportedToast", "已檢舉並封鎖。");
        ...
        zhHant.put("LuminaSttEngineVoskShort", "Vosk");
        zhHant.put("LuminaSttEngineWhisperShort", "Whisper");
        zhHant.put("LuminaSttEngineGoogleShort", "Google");
        ...
        zhHant.put("LuminaSttModelsTitle", "離線語音模型");
        zhHant.put("LuminaSttModelsNone", "未選擇");
        zhHant.put("LuminaSttModelInstalled", "已安裝 · %1$s");
        zhHant.put("LuminaSttModelDownloadSize", "下載 · %1$s");
        zhHant.put("LuminaSttModelsInfo", "Vosk 只為以下語言提供離線模型，其他語言無法在本機轉錄。點一下語言即可下載對應模型並用於轉錄；長按已下載的模型可以刪除。");
        zhHant.put("LuminaSttModelsStorage", "本機語音模型佔用：%1$s");
        zhHant.put("LuminaSttDeleteModel", "刪除語音模型");
        zhHant.put("LuminaSttDeleteModelConfirm", "刪除 %1$s 語音模型？可釋放 %2$s，隨時可以重新下載。");
        zhHant.put("LuminaSttModelDeleted", "已刪除 %1$s 語音模型");
...
zhHant.put("LuminaDigestTitle", "未讀摘要");
        ...
        zhHant.put("LuminaTranslateMoreHeader", "更多");
        zhHant.put("LuminaExplainSetting", "解釋這則訊息");
        zhHant.put("LuminaExplainSettingInfo", "在訊息長按選單裡加入「解釋一下」，用你自己的 LLM 拆解語氣、俚語和該怎麼回。");
        zhHant.put("LuminaGroupSkipSetting", "群組裡跳過你看得懂的語言");
        zhHant.put("LuminaGroupSkipSettingInfo", "群組開啟翻譯時，已經是你看得懂的語言的訊息就不翻譯。");
        zhHant.put("LuminaReverseVoiceSetting", "把文字翻譯後當語音發送");
        zhHant.put("LuminaReverseVoiceSettingInfo", "實驗性。長按傳送鍵把你的文字翻譯後，以裝置合成的語音訊息發出。");
        zhHant.put("LuminaStrangerInboxHeader", "陌生人請求");
        zhHant.put("LuminaStrangerInbox", "陌生人請求匣");
        zhHant.put("LuminaStrangerInboxInfo", "把非聯絡人、且與你沒有共同群組的人發來的訊息，收進獨立的請求清單，而不是主聊天清單。");
        ...
        ar.put("LuminaTrSendEnableDialog", "ترجمة رسائلي في هذه المحادثة");
        ar.put("LuminaTrSendDisableDialog", "إيقاف الترجمة قبل الإرسال هنا");
        ar.put("LuminaTrSendDialogEnabled", "تم تفعيل الترجمة قبل الإرسال لهذه المحادثة");
        ar.put("LuminaTrSendDialogDisabled", "تم إيقاف الترجمة قبل الإرسال لهذه المحادثة");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        ar.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        ar.put("LuminaTranslateTitle", "الترجمة التلقائية");
        ar.put("LuminaTranslateHeader", "الترجمة");
        ar.put("LuminaTranslateTo", "الترجمة إلى");
        ar.put("LuminaDualLanguageDisplay", "ترجمة تلقائية (لغتان)");
        ar.put("LuminaFoldOriginalLongMessages", "طيّ النص الأصلي في الرسائل الطويلة");
        ar.put("LuminaFoldOriginalLongMessagesInfo", "في الرسائل الطويلة ثنائية اللغة، يُطوى النص الأصلي إلى سطر واحد حتى لا يملأ المحادثة. انقر عليه لتوسيعه. تُعرض الترجمة دائمًا كاملة.");
        ar.put("LuminaExpandOriginal", "عرض النص الأصلي");
        ...
        ar.put("LuminaTranslateSendLangAutoShort", "تلقائي");
        ...
        ar.put("LuminaTranslateBeforeSendInfo", "هذا يفعّل الميزة فقط ولا يترجم أي محادثة من تلقاء نفسه. فعّلها لكل محادثة على حدة: اضغط مطوّلًا على زر الإرسال، أو افتح قائمة الترجمة الخاصة بالمحادثة.");
        ...
        ar.put("LuminaMediaSaveFolderInfo", "تُحفظ الصور ومقاطع الفيديو والملفات التي تحفظها في معرض الصور داخل ألبوم بهذا الاسم، ضمن Pictures وMovies وDownload وMusic. اتركه فارغًا لاستخدام مجلد LuminaGram. الوسائط المحفوظة قبل هذا التحديث تبقى في مجلد Telegram القديم — هذا الإعداد لا ينقل الملفات الموجودة.");
        ...
        ar.put("LuminaVaultIconInfo", "أثناء تشغيل الخزنة، تتطابق أيقونة الشاشة الرئيسية والاسم تلقائيًا مع التطبيق الخادع. ولاختيار أيقونة خاصة بك، حدّدها من «تمويه التطبيق» بالأعلى.");
        ...
        ar.put("LuminaSttEngineVoskShort", "Vosk");
        ar.put("LuminaSttEngineWhisperShort", "Whisper");
        ar.put("LuminaSttEngineGoogleShort", "Google");
        ...
        ar.put("LuminaSttModelsTitle", "نماذج صوتية دون إنترنت");
        ar.put("LuminaSttModelsNone", "لا شيء");
        ar.put("LuminaSttModelInstalled", "مثبّت · %1$s");
        ar.put("LuminaSttModelDownloadSize", "تنزيل · %1$s");
        ar.put("LuminaSttModelsInfo", "توفّر Vosk نماذج دون إنترنت لهذه اللغات فقط، أما اللغات الأخرى فلا يمكن تفريغها على جهازك. اضغط على لغة لتنزيل نموذجها واستخدامه في التفريغ، واضغط مطولاً على نموذج مُنزّل لحذفه.");
        ar.put("LuminaSttModelsStorage", "نماذج الصوت على هذا الجهاز: %1$s");
        ar.put("LuminaSttDeleteModel", "حذف نموذج الصوت");
        ar.put("LuminaSttDeleteModelConfirm", "هل تريد حذف نموذج الصوت %1$s؟ سيوفّر ذلك %2$s ويمكنك تنزيله مجدداً في أي وقت.");
        ar.put("LuminaSttModelDeleted", "تم حذف نموذج الصوت %1$s");
...
ar.put("LuminaDigestTitle", "ملخص غير المقروء");
        ...
        ru.put("LuminaTrSendEnableDialog", "Переводить мои сообщения в этом чате");
        ru.put("LuminaTrSendDisableDialog", "Выключить перевод перед отправкой здесь");
        ru.put("LuminaTrSendDialogEnabled", "Перевод перед отправкой включён для этого чата");
        ru.put("LuminaTrSendDialogDisabled", "Перевод перед отправкой выключен для этого чата");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        ru.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        ru.put("LuminaTranslateTitle", "Автоперевод");
        ru.put("LuminaTranslateHeader", "Перевод");
        ru.put("LuminaTranslateTo", "Переводить на");
        ru.put("LuminaDualLanguageDisplay", "Автоперевод (два языка)");
        ru.put("LuminaFoldOriginalLongMessages", "Сворачивать оригинал в длинных сообщениях");
        ru.put("LuminaFoldOriginalLongMessagesInfo", "В длинных двуязычных сообщениях оригинал сворачивается в одну строку, чтобы не засорять чат. Нажмите, чтобы развернуть. Перевод всегда показывается полностью.");
        ru.put("LuminaExpandOriginal", "Показать оригинал");
        ...
        ru.put("LuminaTranslateSendLangAutoShort", "Авто");
        ...
        ru.put("LuminaTranslateBeforeSendInfo", "Это лишь включает функцию — сама по себе она ничего не переводит. Включите её отдельно для каждого чата: долгое нажатие на кнопку отправки или меню перевода чата.");
        ...
        ru.put("LuminaMediaSaveFolderInfo", "Фотографии, видео и файлы, сохраняемые в галерею, попадают в альбом с этим именем — в Pictures, Movies, Download и Music. Оставьте пустым, чтобы использовать папку LuminaGram. Медиа, сохранённые до этого обновления, остаются в старой папке Telegram — эта настройка не перемещает уже сохранённые файлы.");
        ...
        ru.put("LuminaVaultIconInfo", "Пока сейф включён, значок и название на главном экране автоматически совпадают с обманкой. Чтобы выбрать значок самому, задайте его в разделе «Маскировка приложения» выше.");
        ...
        ru.put("LuminaSttEngineVoskShort", "Vosk");
        ru.put("LuminaSttEngineWhisperShort", "Whisper");
        ru.put("LuminaSttEngineGoogleShort", "Google");
        ...
        ru.put("LuminaSttModelsTitle", "Офлайн-модели распознавания");
        ru.put("LuminaSttModelsNone", "Не выбрана");
        ru.put("LuminaSttModelInstalled", "Установлена · %1$s");
        ru.put("LuminaSttModelDownloadSize", "Загрузить · %1$s");
        ru.put("LuminaSttModelsInfo", "Vosk выпускает офлайн-модели только для этих языков — остальные языки распознать на устройстве нельзя. Нажмите на язык, чтобы загрузить его модель и использовать её для распознавания. Удерживайте загруженную модель, чтобы удалить её.");
        ru.put("LuminaSttModelsStorage", "Голосовые модели на устройстве: %1$s");
        ru.put("LuminaSttDeleteModel", "Удалить голосовую модель");
        ru.put("LuminaSttDeleteModelConfirm", "Удалить голосовую модель «%1$s»? Освободится %2$s, и её можно будет загрузить снова в любой момент.");
        ru.put("LuminaSttModelDeleted", "Голосовая модель «%1$s» удалена");
...
ru.put("LuminaDigestTitle", "Сводка непрочитанных");
        ...
        fa.put("LuminaTrSendEnableDialog", "ترجمهٔ پیام‌های من در این گفتگو");
        fa.put("LuminaTrSendDisableDialog", "خاموش کردن ترجمه پیش از ارسال در اینجا");
        fa.put("LuminaTrSendDialogEnabled", "ترجمه پیش از ارسال برای این گفتگو روشن شد");
        fa.put("LuminaTrSendDialogDisabled", "ترجمه پیش از ارسال برای این گفتگو خاموش شد");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        fa.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        fa.put("LuminaTranslateTitle", "ترجمه خودکار");
        fa.put("LuminaTranslateHeader", "ترجمه");
        fa.put("LuminaTranslateTo", "ترجمه به");
        fa.put("LuminaDualLanguageDisplay", "ترجمهٔ خودکار (دو زبانه)");
        fa.put("LuminaFoldOriginalLongMessages", "جمع‌کردن متن اصلی در پیام‌های بلند");
        fa.put("LuminaFoldOriginalLongMessagesInfo", "در پیام‌های بلندِ دوزبانه، متن اصلی به یک خط جمع می‌شود تا گفتگو را شلوغ نکند. برای باز کردن روی آن ضربه بزنید. ترجمه همیشه به‌طور کامل نمایش داده می‌شود.");
        fa.put("LuminaExpandOriginal", "نمایش متن اصلی");
        ...
        fa.put("LuminaTranslateSendLangAutoShort", "خودکار");
        ...
        fa.put("LuminaTranslateBeforeSendInfo", "این فقط قابلیت را فعال می‌کند و به‌تنهایی هیچ گفتگویی را ترجمه نمی‌کند. آن را برای هر گفتگو جداگانه روشن کنید: دکمهٔ ارسال را نگه دارید یا منوی ترجمهٔ گفتگو را باز کنید.");
        ...
        fa.put("LuminaMediaSaveFolderInfo", "عکس‌ها، ویدیوها و فایل‌هایی که در گالری ذخیره می‌کنید در آلبومی با این نام قرار می‌گیرند؛ در Pictures، Movies، Download و Music. برای استفاده از پوشه LuminaGram آن را خالی بگذارید. رسانه‌هایی که پیش از این به‌روزرسانی ذخیره شده‌اند در پوشه قدیمی Telegram باقی می‌مانند — این تنظیم فایل‌های موجود را جابه‌جا نمی‌کند.");
        ...
        fa.put("LuminaVaultIconInfo", "تا زمانی که گاوصندوق روشن است، نماد و نام روی صفحهٔ اصلی به‌طور خودکار با برنامهٔ فریبنده هماهنگ می‌شود. برای انتخاب دلخواه خود، نمادی را از «استتار برنامه» در بالا برگزینید.");
        ...
        fa.put("LuminaSttEngineVoskShort", "Vosk");
        fa.put("LuminaSttEngineWhisperShort", "Whisper");
        fa.put("LuminaSttEngineGoogleShort", "Google");
        ...
        fa.put("LuminaSttModelsTitle", "مدل‌های گفتاری آفلاین");
        fa.put("LuminaSttModelsNone", "انتخاب نشده");
        fa.put("LuminaSttModelInstalled", "نصب‌شده · %1$s");
        fa.put("LuminaSttModelDownloadSize", "دانلود · %1$s");
        fa.put("LuminaSttModelsInfo", "Vosk فقط برای این زبان‌ها مدل آفلاین منتشر می‌کند و زبان‌های دیگر روی دستگاه شما رونویسی نمی‌شوند. روی یک زبان بزنید تا مدلش دانلود و برای رونویسی استفاده شود؛ برای حذف یک مدل دانلودشده، آن را نگه دارید.");
        fa.put("LuminaSttModelsStorage", "مدل‌های گفتاری روی این دستگاه: %1$s");
        fa.put("LuminaSttDeleteModel", "حذف مدل گفتاری");
        fa.put("LuminaSttDeleteModelConfirm", "مدل گفتاری %1$s حذف شود؟ %2$s آزاد می‌شود و هر وقت بخواهید می‌توانید دوباره دانلودش کنید.");
        fa.put("LuminaSttModelDeleted", "مدل گفتاری %1$s حذف شد");
...
fa.put("LuminaDigestTitle", "خلاصه خوانده‌نشده‌ها");
        ...
        tr.put("LuminaTrSendEnableDialog", "Bu sohbette mesajlarımı çevir");
        tr.put("LuminaTrSendDisableDialog", "Burada göndermeden önce çeviriyi kapat");
        tr.put("LuminaTrSendDialogEnabled", "Bu sohbet için göndermeden önce çeviri açık");
        tr.put("LuminaTrSendDialogDisabled", "Bu sohbet için göndermeden önce çeviri kapalı");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        tr.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        tr.put("LuminaTranslateTitle", "Otomatik çeviri");
        tr.put("LuminaTranslateHeader", "Çeviri");
        tr.put("LuminaTranslateTo", "Şu dile çevir");
        tr.put("LuminaDualLanguageDisplay", "Otomatik çeviri (iki dilli)");
        tr.put("LuminaFoldOriginalLongMessages", "Uzun mesajlarda orijinali katla");
        tr.put("LuminaFoldOriginalLongMessagesInfo", "Uzun iki dilli mesajlarda orijinal metin, sohbeti doldurmaması için tek satıra katlanır. Genişletmek için dokunun. Çeviri her zaman tam gösterilir.");
        tr.put("LuminaExpandOriginal", "Orijinali göster");
        ...
        tr.put("LuminaTranslateSendLangAutoShort", "Otomatik");
        ...
        tr.put("LuminaTranslateBeforeSendInfo", "Bu yalnızca özelliği etkinleştirir; tek başına hiçbir sohbeti çevirmez. Her sohbet için ayrı ayrı açın: Gönder düğmesine uzun basın veya sohbetin çeviri menüsünü açın.");
        ...
        tr.put("LuminaMediaSaveFolderInfo", "Galeriye kaydettiğiniz fotoğraflar, videolar ve dosyalar; Pictures, Movies, Download ve Music altında bu adı taşıyan bir albüme kaydedilir. LuminaGram klasörünü kullanmak için boş bırakın. Bu güncellemeden önce kaydettiğiniz medya eski Telegram klasöründe kalır — bu ayar mevcut dosyaları taşımaz.");
        ...
        tr.put("LuminaVaultIconInfo", "Kasa açıkken ana ekrandaki simge ve ad, sahte uygulamayla otomatik olarak eşleşir. Kendi seçtiğiniz bir simgeyi korumak için yukarıdaki “Uygulama gizleme” bölümünden bir simge seçin.");
        ...
        tr.put("LuminaSttEngineVoskShort", "Vosk");
        tr.put("LuminaSttEngineWhisperShort", "Whisper");
        tr.put("LuminaSttEngineGoogleShort", "Google");
        ...
        tr.put("LuminaSttModelsTitle", "Çevrimdışı ses modelleri");
        tr.put("LuminaSttModelsNone", "Seçilmedi");
        tr.put("LuminaSttModelInstalled", "Yüklü · %1$s");
        tr.put("LuminaSttModelDownloadSize", "İndir · %1$s");
        tr.put("LuminaSttModelsInfo", "Vosk çevrimdışı modelleri yalnızca bu diller için yayımlıyor; diğer diller cihazınızda yazıya dökülemez. Modelini indirip yazıya dökmede kullanmak için bir dile dokunun. İndirilmiş bir modeli silmek için uzun basın.");
        tr.put("LuminaSttModelsStorage", "Bu cihazdaki ses modelleri: %1$s");
        tr.put("LuminaSttDeleteModel", "Ses modelini sil");
        tr.put("LuminaSttDeleteModelConfirm", "%1$s ses modeli silinsin mi? %2$s yer açılır ve istediğiniz zaman yeniden indirebilirsiniz.");
        tr.put("LuminaSttModelDeleted", "%1$s ses modeli silindi");
...
tr.put("LuminaDigestTitle", "Okunmamış özeti");
        ...
        es.put("LuminaTrSendEnableDialog", "Traducir mis mensajes en este chat");
        es.put("LuminaTrSendDisableDialog", "Desactivar traducir antes de enviar aquí");
        es.put("LuminaTrSendDialogEnabled", "Traducir antes de enviar activado para este chat");
        es.put("LuminaTrSendDialogDisabled", "Traducir antes de enviar desactivado para este chat");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        es.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        es.put("LuminaTranslateTitle", "Autotraducción");
        es.put("LuminaTranslateHeader", "Traducción");
        es.put("LuminaTranslateTo", "Traducir a");
        es.put("LuminaDualLanguageDisplay", "Traducción automática (bilingüe)");
        es.put("LuminaFoldOriginalLongMessages", "Plegar el original en mensajes largos");
        es.put("LuminaFoldOriginalLongMessagesInfo", "En los mensajes bilingües largos, el original se pliega en una línea para no saturar el chat. Tócalo para expandirlo. La traducción siempre se muestra completa.");
        es.put("LuminaExpandOriginal", "Mostrar original");
        ...
        es.put("LuminaTranslateSendLangAutoShort", "Automático");
        ...
        es.put("LuminaTranslateBeforeSendInfo", "Esto solo activa la función; por sí sola no traduce ningún chat. Actívala en cada chat por separado: mantén pulsado el botón de enviar o abre el menú de traducción del chat.");
        ...
        es.put("LuminaMediaSaveFolderInfo", "Las fotos, los videos y los archivos que guardas en tu galería se colocan en un álbum con este nombre, dentro de Pictures, Movies, Download y Music. Déjalo vacío para usar la carpeta LuminaGram. Lo que guardaste antes de esta actualización permanece en la antigua carpeta Telegram: este ajuste no mueve los archivos existentes.");
        ...
        es.put("LuminaVaultIconInfo", "Mientras la caja fuerte esté activada, el icono y el nombre en la pantalla de inicio coinciden automáticamente con la app señuelo. Para conservar un icono propio, elige uno en «Disfraz de la app» arriba.");
        ...
        es.put("LuminaSttEngineVoskShort", "Vosk");
        es.put("LuminaSttEngineWhisperShort", "Whisper");
        es.put("LuminaSttEngineGoogleShort", "Google");
        ...
        es.put("LuminaSttModelsTitle", "Modelos de voz sin conexión");
        es.put("LuminaSttModelsNone", "Ninguno");
        es.put("LuminaSttModelInstalled", "Instalado · %1$s");
        es.put("LuminaSttModelDownloadSize", "Descargar · %1$s");
        es.put("LuminaSttModelsInfo", "Vosk publica modelos sin conexión solo para estos idiomas; los demás no se pueden transcribir en tu dispositivo. Toca un idioma para descargar su modelo y usarlo en la transcripción. Mantén pulsado un modelo descargado para eliminarlo.");
        es.put("LuminaSttModelsStorage", "Modelos de voz en este dispositivo: %1$s");
        es.put("LuminaSttDeleteModel", "Eliminar modelo de voz");
        es.put("LuminaSttDeleteModelConfirm", "¿Eliminar el modelo de voz %1$s? Se liberarán %2$s y podrás descargarlo de nuevo cuando quieras.");
        es.put("LuminaSttModelDeleted", "Modelo de voz %1$s eliminado");
...
es.put("LuminaDigestTitle", "Resumen de no leídos");
        ...
        ptBr.put("LuminaTrSendEnableDialog", "Traduzir minhas mensagens nesta conversa");
        ptBr.put("LuminaTrSendDisableDialog", "Desativar traduzir antes de enviar aqui");
        ptBr.put("LuminaTrSendDialogEnabled", "Traduzir antes de enviar ativado para esta conversa");
        ptBr.put("LuminaTrSendDialogDisabled", "Traduzir antes de enviar desativado para esta conversa");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        ptBr.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        ...
        ptBr.put("LuminaDualLanguageDisplay", "Tradução automática (bilíngue)");
        ptBr.put("LuminaFoldOriginalLongMessages", "Recolher o original em mensagens longas");
        ptBr.put("LuminaFoldOriginalLongMessagesInfo", "Em mensagens bilíngues longas, o original é recolhido em uma linha para não lotar a conversa. Toque para expandir. A tradução é sempre mostrada por completo.");
        ptBr.put("LuminaExpandOriginal", "Mostrar original");
        ...
        ptBr.put("LuminaTranslateSendLangAutoShort", "Automático");
        ...
        ptBr.put("LuminaTranslateBeforeSendInfo", "Isto apenas ativa o recurso; sozinho ele não traduz nenhuma conversa. Ative em cada conversa separadamente: mantenha pressionado o botão de enviar ou abra o menu de tradução da conversa.");
        ...
        ptBr.put("LuminaMediaSaveFolderInfo", "As fotos, os vídeos e os arquivos que você salva na galeria vão para um álbum com este nome, em Pictures, Movies, Download e Music. Deixe em branco para usar a pasta LuminaGram. O que você salvou antes desta atualização permanece na antiga pasta Telegram — esta configuração não move arquivos existentes.");
        ...
        ptBr.put("LuminaVaultIconInfo", "Enquanto o cofre estiver ativado, o ícone e o nome na tela inicial acompanham automaticamente o app falso. Para manter um ícone seu, escolha um em “Disfarce do app” acima.");
        ...
        ptBr.put("LuminaSttEngineVoskShort", "Vosk");
        ptBr.put("LuminaSttEngineWhisperShort", "Whisper");
        ptBr.put("LuminaSttEngineGoogleShort", "Google");
        ...
        ptBr.put("LuminaSttModelsTitle", "Modelos de voz offline");
        ptBr.put("LuminaSttModelsNone", "Nenhum");
        ptBr.put("LuminaSttModelInstalled", "Instalado · %1$s");
        ptBr.put("LuminaSttModelDownloadSize", "Baixar · %1$s");
        ptBr.put("LuminaSttModelsInfo", "A Vosk publica modelos offline apenas para estes idiomas; os demais não podem ser transcritos no seu aparelho. Toque em um idioma para baixar o modelo dele e usá-lo na transcrição. Mantenha pressionado um modelo baixado para excluí-lo.");
        ptBr.put("LuminaSttModelsStorage", "Modelos de voz neste aparelho: %1$s");
        ptBr.put("LuminaSttDeleteModel", "Excluir modelo de voz");
        ptBr.put("LuminaSttDeleteModelConfirm", "Excluir o modelo de voz %1$s? Isso libera %2$s e você pode baixá-lo novamente quando quiser.");
        ptBr.put("LuminaSttModelDeleted", "Modelo de voz %1$s excluído");
...
ptBr.put("LuminaDigestTitle", "Resumo de não lidas");
        ...
        id.put("LuminaTrSendEnableDialog", "Terjemahkan pesan saya di obrolan ini");
        id.put("LuminaTrSendDisableDialog", "Matikan terjemahan sebelum kirim di sini");
        id.put("LuminaTrSendDialogEnabled", "Terjemahan sebelum kirim aktif untuk obrolan ini");
        id.put("LuminaTrSendDialogDisabled", "Terjemahan sebelum kirim nonaktif untuk obrolan ini");
        // Chat title-bar language menu (two rows, one per direction).
        ...
        id.put("ProfileRiskHomoglyph", "⚠ Name uses look-alike characters — may be impersonating someone");
        ...
        id.put("LuminaDualLanguageDisplay", "Terjemahan otomatis (dwibahasa)");
        id.put("LuminaFoldOriginalLongMessages", "Lipat teks asli di pesan panjang");
        id.put("LuminaFoldOriginalLongMessagesInfo", "Pada pesan dwibahasa yang panjang, teks asli dilipat menjadi satu baris agar tidak memenuhi obrolan. Ketuk untuk membentangkan. Terjemahan selalu ditampilkan penuh.");
        id.put("LuminaExpandOriginal", "Tampilkan asli");
        ...
        id.put("LuminaTranslateSendLangAutoShort", "Otomatis");
        ...
        id.put("LuminaTranslateBeforeSendInfo", "Ini hanya mengaktifkan fitur — dengan sendirinya tidak menerjemahkan obrolan apa pun. Aktifkan untuk tiap obrolan secara terpisah: tekan lama tombol Kirim, atau buka menu terjemahan obrolan.");
        ...
        id.put("LuminaMediaSaveFolderInfo", "Foto, video, dan berkas yang Anda simpan ke galeri akan masuk ke album dengan nama ini, di dalam Pictures, Movies, Download, dan Music. Biarkan kosong untuk menggunakan folder LuminaGram. Media yang disimpan sebelum pembaruan ini tetap berada di folder Telegram yang lama — pengaturan ini tidak memindahkan berkas yang sudah ada.");
        ...
        id.put("LuminaVaultIconInfo", "Selama brankas aktif, ikon dan nama di layar utama otomatis mengikuti aplikasi umpan. Untuk memakai ikon pilihan Anda sendiri, tentukan satu di “Penyamaran aplikasi” di atas.");
        ...
        id.put("LuminaSttEngineVoskShort", "Vosk");
        id.put("LuminaSttEngineWhisperShort", "Whisper");
        id.put("LuminaSttEngineGoogleShort", "Google");
        ...
        id.put("LuminaSttModelsTitle", "Model suara offline");
        id.put("LuminaSttModelsNone", "Belum dipilih");
        id.put("LuminaSttModelInstalled", "Terpasang · %1$s");
        id.put("LuminaSttModelDownloadSize", "Unduh · %1$s");
        id.put("LuminaSttModelsInfo", "Vosk hanya menyediakan model offline untuk bahasa-bahasa berikut; bahasa lain tidak bisa ditranskripsi di perangkat Anda. Ketuk sebuah bahasa untuk mengunduh modelnya dan memakainya untuk transkripsi. Tekan lama model yang sudah diunduh untuk menghapusnya.");
        id.put("LuminaSttModelsStorage", "Model suara di perangkat ini: %1$s");
        id.put("LuminaSttDeleteModel", "Hapus model suara");
        id.put("LuminaSttDeleteModelConfirm", "Hapus model suara %1$s? Ini membebaskan %2$s dan Anda bisa mengunduhnya lagi kapan saja.");
        id.put("LuminaSttModelDeleted", "Model suara %1$s dihapus");
